...
static const char*	vert_text_path = "../bin_execute/shaders/text.vert";		// text vertex shaders
static const char*	frag_text_path = "../bin_execute/shaders/text.frag";		// text fragment shaders
